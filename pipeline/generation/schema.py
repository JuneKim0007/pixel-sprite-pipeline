...
FIELDS: list[ConfigField] = [
    ...
    ConfigField(key="proportions.head", label="Head size", kind="float", default=1.0,
     min=0.2, max=3.0, step=0.05, group="Proportions",
     help="Also grows the skull in the depth map, which is where head volume actually reads."),
    ConfigField(key="proportions.neck", label="Neck length", kind="float", default=1.0,
     min=0.3, max=3.0, step=0.05, group="Proportions",
     help="1.0 is the rig's default. 2.0 gives a giraffe-like or serpentine neck."),
    ConfigField(key="proportions.torso", label="Torso length", kind="float", default=1.0,
     min=0.3, max=3.0, step=0.05, group="Proportions",
     help="Stretches the spine; the limbs follow their anchors."),
    ConfigField(key="proportions.arms", label="Arm length", kind="float", default=1.0,
     min=0.3, max=3.0, step=0.05, group="Proportions",
     help="Long-armed apes, short-armed brawlers."),
    ConfigField(key="proportions.legs", label="Leg length", kind="float", default=1.0,
     min=0.3, max=3.0, step=0.05, group="Proportions",
    ...
    ConfigField(key="proportions.tail", label="Tail length", kind="float", default=1.0,
     min=0.3, max=3.0, step=0.05, group="Proportions",
     help="Ignored by rigs with no tail."),
    ConfigField(key="proportions.wings", label="Wing span", kind="float", default=1.0,
     min=0.3, max=3.0, step=0.05, group="Proportions",
     help="Ignored by rigs with no wings."),
    ConfigField(key="proportions.tentacles", label="Tentacle length", kind="float", default=1.0,
     min=0.3, max=3.0, step=0.05, group="Proportions",
     help="Octopoid rigs only."),
    ConfigField(key="proportions.segments", label="Segment length", kind="float", default=1.0,
     min=0.3, max=3.0, step=0.05, group="Proportions",
